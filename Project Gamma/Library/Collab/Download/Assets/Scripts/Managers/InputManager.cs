...
public class InputManager : MonoBehaviour {
	...
	public KeyCode ability = KeyCode.Mouse0; // The key to use ability
	//public KeyCode interact = KeyCode.Mouse0; // The key to interact
	public KeyCode change = KeyCode.Mouse1; // The key to change characters
	...
	[HideInInspector] public bool inputA; // Bool for whether the player is pressing the button
	...
	void Update () {
		if (canMove) { // If the player can move
			...
			inputJ = Input.GetKeyDown (jump); // Getting input for using ability
			inputA = Input.GetKeyDown (ability); // Getting input for using ability
